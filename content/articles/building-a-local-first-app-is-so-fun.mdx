...
description: "Brain dump on my recent experience building a local first app for macOS"
...
- How to synchronize server data with client memory
- How to deal with network latency and request speeds
...
If you're a DJ or have lots of downloaded music on your macOS device, check out Cratebase.I'll be writing much more about what I learned while building the app and working with Electron in general.
