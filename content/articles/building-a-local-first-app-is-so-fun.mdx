...
Over the last 6 months I have been working on a macOS app called [Cratebase](https://www.cratebase.app/). In short, the app provides tools to help music collectors better manage their music libraries.
