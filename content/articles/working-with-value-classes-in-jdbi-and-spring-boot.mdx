...
If you just want to see the completed code demo for this, check out the repository [here]("https://ucarecdn.com/367c0ae2-68ac-4c14-9b19-973c66e81773/draganddropinreactwithdndkit.png").
...
public class BaseUUIDColumnMapperFactory implements ColumnMapperFactory {  
    ...
    public Optional<ColumnMapper<?>> build(Type type, ConfigRegistry config) { 
        ...
        return Optional.of((rs, columnNumber, ctx) -> {  
            try {  
               var uuid = readColumnAsNativeUUID(rs, columnNumber);  
  
                if (uuid == null) {  
                    return null;  
                }  
  
                return createBaseUUIDObject(clazz, uuid);  
            } catch (Exception e) {  
    ...
    private static Object createBaseUUIDObject(Class<?> clazz, UUID uuid) throws  
    ...
    private UUID readColumnAsNativeUUID(ResultSet rs, int columnNumber) throws SQLException {  
