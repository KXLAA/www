...
ogImage: "https://ucarecdn.com/4dfc29bc-c051-4094-9d68-d6395c9fcf76/nsfwjs.png"
---
...
This is the comma operator in action. If you look at any minified JavaScript code, you'll see that this operator is always present. It's a handy way to save space and write concise code.
...
Essentially, in the code above, the `console.log` statement would print `'does this work?' `and the function would return the string `'returned value'`. The `console.log` on the right is evaluated or called and thrown away and the string on the right is evaluated and returned as a value.
