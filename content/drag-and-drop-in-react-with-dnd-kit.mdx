...
In the demo above, the droppable area spans the entire viewport, enabling us to drag and drop our draggable components anywhere. This is similar to canvas-based applications like Figma and Excalidraw.

We can also have fixed, designated droppable areas for our draggable components, like this:
...
<Callout intent="info" heading="Callback Refs">
  ...
  element as an argument. It's a way to access HTML elements directly in React.
