...
You can check out the documentation for more details about these primitives and presets. For now, let's explore how to use the primitives and presets to create different drag-and-drop interactions. We'll look at four common types:
